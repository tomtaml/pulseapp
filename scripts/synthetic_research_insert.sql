INSERT INTO submissions (
  ...
  4,
  4,
  '{"schema_version":"research-v1.2","app_version":"1.0.0","variant":"fi-fleet","workshop_code":"TEST_PIPELINE","participant_group":"fleet_driver","language":"fi","winter_condition":"snow","current_soc":55,"minimum_soc":65,"departure_time":"17:00","dwell_minutes":75,"comprehension_items":[true,true,true,true],"sus_values":[4,1,5,1,4,1,5,1,4,1],"alignment_method":"guided","alignment_clarity":4,"constraint_owner":"shared","constraint_clarity":4,"v2g_authorisation":"automatic_override","preuse_v2g_acceptance":4,"cycle_completed":true,"cycle_overridden":false,,"energy_flow_clarity":5,"fault_decision":"support","fault_owner":"dispatcher","trust_reliability":4,"trust_predictability":4,"control_confidence":5,"failure_recovery_confidence":4,"wireless_use_intention":4,"v2g_acceptance_under_guarantees":4,"synthetic_test":true}',
  'synthetic_test'
);
