...
const TRANSITIONS = Object.freeze({
  ...
  V2G_AVAILABLE: ["V2G_ACTIVE", "RECHARGING", "PAUSED", "READY_TO_DEPART", "OVERRIDDEN", "FAULT"],
  V2G_ACTIVE: ["RECHARGING", "PAUSED", "READY_TO_DEPART", "OVERRIDDEN", "FAULT"],
  RECHARGING: ["READY_TO_DEPART", "PAUSED", "FAULT", "OVERRIDDEN"],
  READY_TO_DEPART: ["SESSION_ENDED", "CHARGING", "OVERRIDDEN"],
  PAUSED: ["READY", "CHARGING", "V2G_AVAILABLE", "RECHARGING", "READY_TO_DEPART", "FAULT", "SESSION_ENDED"],
